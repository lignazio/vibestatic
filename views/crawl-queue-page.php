 ...
 */
$paginator_index = 'wp2static-crawl-queue';
...
$paginator_label = __( 'Crawl Queue', 'vibestatic' );
...
<div class="wrap">
    ...
    <form id="posts-filter" method="POST">
        ...
        <p class="search-box">
            <label class="screen-reader-text" for="post-search-input"><?php esc_html_e( 'Search Crawl Queue URLs:', 'vibestatic' ); ?></label>
        ...
        <table class="wp-list-table widefat striped">
            <thead>
                <tr>
                    ...
                    <th><?php esc_html_e( 'URLs in Crawl Queue', 'vibestatic' ); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php if ( ! $paginator_total_records ) : ?>
                    <tr>
                        <td colspan="2"><?php esc_html_e( 'Crawl queue is empty.', 'vibestatic' ); ?></td>
                    </tr>
                <?php endif; ?>

                <?php foreach ( $paginator_records as $paginator_id => $url ) : ?>
                    <tr>
