 ...
 */
$paginator_index = 'wp2static-static-site';
...
$paginator_label = __( 'Generated Static Site', 'vibestatic' );
...
<div class="wrap">
    ...
    <form id="posts-filter" method="GET">
        ...
        <p class="search-box">
            <label class="screen-reader-text" for="post-search-input"><?php esc_html_e( 'Search generated static site paths:', 'vibestatic' ); ?></label>
        ...
        <table class="wp-list-table widefat striped">
            <thead>
                <tr>
                    <th><?php esc_html_e( 'Paths in Generated Static Site', 'vibestatic' ); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php if ( ! $paginator_total_records ) : ?>
                    <tr>
                        <td><?php esc_html_e( 'Generated static site directory is empty.', 'vibestatic' ); ?></td>
                    </tr>
                <?php endif; ?>
