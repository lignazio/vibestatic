 ...
 *
 * The upstream boilerplate was copied into ten repositories as two hundred and
 * fifty lines of Controller, and every copy carried the same four defects:
 * table names interpolated into SQL, a seed that inserted a duplicate row on
 * each call, a save that silently did nothing when the row was missing, and
 * labels frozen into the database in whichever language happened to be active
 * on first use. One class, here, instead of ten copies of those.
 *
 * Writing an add-on of your own: declare your options and hand them to this.
 *
 * @package WP2Static
 */
